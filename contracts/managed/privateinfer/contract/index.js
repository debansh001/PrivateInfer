...
(function (QueryStatus) {
  QueryStatus[QueryStatus['PROCESSING'] = 0] = 'PROCESSING';
  QueryStatus[QueryStatus['RESULT_READY'] = 1] = 'RESULT_READY';
  QueryStatus[QueryStatus['PAID'] = 2] = 'PAID';
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      submitResult: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`submitResult: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const resultProofHash_0 = args_1[1];
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(resultProofHash_0),
      ...
      releasePayment: (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`releasePayment: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('releasePayment',
                                     'argument 1 (as invoked from Typescript)',
                                     'privateinfer.compact line 32 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        ...
        const result_0 = this._releasePayment_0(context, partialProofData);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
  ...
  initialState(...args_0) {
    ...
    if (!(commitment_0.buffer instanceof ArrayBuffer && commitment_0.BYTES_PER_ELEMENT === 1 && commitment_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'privateinfer.compact line 14 char 1',
                                 'Bytes<32>',
                                 commitment_0)
    }
  ...
  _callerAddress_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('callerAddress',
                                 'return value',
                                 'privateinfer.compact line 12 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _submitResult_0(context, partialProofData, resultProofHash_0) {
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(1n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(resultProofHash_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _releasePayment_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
